...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_query($conn, $sql)) {
        // Redirect to the vendors list page after successful update
        header('Location: ../vendorsList.php');
        exit();
    } else {
...
// Fetch the vendor details for pre-filling the form
if (isset($_GET['updateid'])) {
    $first_name = $_GET['updateid'];
    $sql = "SELECT * FROM vendors WHERE first_name = '$first_name'";
...
<body>
    <div class="content-section">
        ...
        <form method="POST" action="">
            ...
            <button type="submit" name="submit">Update Vendor</button>
        </form>
    </div>
</body>
